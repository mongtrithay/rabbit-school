    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col md:flex-row max-w-8xl mx-auto bg-sky-700 shadow-lg overflow-hidden h-[500px] mt-8">
        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
          <h1 className="text-[40px] font-bold text-white ml-8">EXPLORE JOB</h1>
     ...
     //section2 */}
      ...
      <div className="flex flex-col md:flex-row max-w-10xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden h-auto">
        <div className="w-full md:w-1/2 p-8 border-r-2 border-sky-700">
          <h1 className="text-[40px] font-bold text-sky-700 ml-8 mb-6 text-center">
            AVAILABLE POSITIONS
          </h1>
        ...
        <div className="w-full md:w-1/2 p-8 bg-white-100">
          <h1 className="text-[40px] font-bold text-sky-700 mb-6 text-center">
            COMPANY BENEFITS
          </h1>
          <ul className="space-y-8 ml-8">
            <li className="flex items-center">
              <FontAwesomeIcon
                icon={faSackDollar}
                className="w-[100px] h-[100px] text-sky-700"
              />
              <div className="ml-8">
        ...
        <div className="w-full md:w-2/2 p-8 bg-white-100">
          ...
          <ul className="space-y-8 ml-8">
            <li className="flex items-center">
              ...
              />
              <div className="ml-12">
                <p className="text-[35px] font-bold text-sky-700  ">
                  Classroom Support
                </p>
                <p className="text-[30px] text-gray-600">
            ...
            <li className="flex items-center">
              ...
              <div className="ml-12">
                ...
                <p className="text-[30px] text-gray-600">
                  Assist in planning and running school events and
                  funFundraisingdraising efforts.
                </p>
              </div>
            </li>
            <li className="flex items-center">
              ...
              />
              <div className="ml-12">
                <p className="text-[40px] font-bold text-sky-700">
                  Academic Guidance
                </p>
                <p className="text-[30px] text-gray-600">
      ...
      <div className="flex flex-col md:flex-row max-w-10xl mx-auto h-[550px]">
        <div className="w-full md:w-1/2 p-8  bg-sky-700 ">
          <h1 className="text-[40px] text-white font-bold mb-6 text-center">
            CONTACT US
          </h1>
          <div className="text-[20px] text-white space-y-4">
            <div>
              <h2 className="font-bold text-[30px] text-white ml-[22%]">
                Phone
              </h2>
            ...
            <div>
              ...
              <p className="text-[25px] ml-[22%] text-white">
        ...
        <div className="relative w-full md:w-1/2 p-8 h-[550px] bg-white">
          ...
          <h1 className="text-[40px] font-bold text-sky-700 mb-6 text-center mt-4">
            GET INVOLVED
          </h1>
