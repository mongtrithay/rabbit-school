...
{/* 
     //section2 */}
      ...
      <div className="flex flex-col md:flex-row max-w-10xl mx-auto h-[564px]p-8">
   <div className="w-full md:w-1/2 p-8 bg-white  ">
    <h1 className="text-[40px] text-sky-700 font-bold mb-6 text-center">CONTACT US</h1>
    <div className="text-[20px] text-gray-700 space-y-4">
      <div>
        <h2 className="font-bold text-[30px] text-sky-700 ml-[22%]">Phone</h2>
        <p className='text-[25px] ml-[22%] text-gray-600'>+855 68 901 971</p>
        <p className='text-[25px] ml-[22%] text-gray-600'>+855 17 525 815</p>
      </div>
      <div>
        <h2 className="font-bold text-[30px] text-sky-700 ml-[22%]">Email</h2>
        <p className='text-[25px] ml-[22%] text-gray-600'>sor.sothearom@rabbitschoolcambodia.net</p>
        <p className='text-[25px] ml-[22%] text-gray-600'>hun.touch@rabbitschoolcambodia.net</p>
      </div>
      <div>
        <h2 className="font-bold text-[30px] text-sky-700 ml-[22%]">Address</h2>
        <p className='text-[25px] ml-[22%] '><a href="https://goo.gl/maps/jvMBC2MgTz1kUyoh6" className="text-gray-600 underline" target="_blank" rel="noopener noreferrer">https://goo.gl/maps/jvMBC2MgTz1kUyoh6</a></p>
      </div>
    </div>
  </div>

  {/* Right Section */}
  <div className="w-full md:w-1/2 p-8 h-[510px] bg-sky-700 ">
  <h1 className="text-[40px] font-bold text-white mb-6 text-center ">GET INVOLVED</h1>
