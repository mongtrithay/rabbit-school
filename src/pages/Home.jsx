...
>
    ...
    <div className="bg-black bg-opacity-50 w-screen">
      ...
      <div className="flex flex-wrap justify-center mt-[4.375rem] lg:-ml-[20rem] -ml-[0.75rem]">
        ...
        <p className="text-white lg:text-[1.25rem] text-[0.30rem] sm:text-[0.75rem] md:text-[1rem] lg:-mt-[4.0625rem] -mt-[3.00rem] lg:ml-[1.875rem] ml-[0.75rem]">
          The Rabbit School is a Cambodian NGO that was established in May 1997.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="hidden lg:flex lg:flex-wrap lg:justify-center lg:space-x-10 mb-10">
    ...
    <div className="w-[300px] h-[400px] bg-[#276BA3] bg-opacity-50 shadow-xl flex flex-col items-center mb-10">
      ...
      />
      <p className="w-[90%] text-center mt-4 text-white">
        In essence, it’s about personal growth and contributing to the growth of others.
      </p>
    </div>
    ...
    <div className="w-[300px] h-[400px] bg-[#276BA3] bg-opacity-50 shadow-xl flex flex-col items-center mb-10">
      ...
      />
      <p className="w-[90%] text-center mt-4 text-white">
        Women and men, and girls and boys, enjoy the same rights, resources, opportunities, and protections.
      </p>
    </div>
  </div>
  ...
  <div className="flex flex-col sm:flex-row lg:flex-row mt-10">
    <div className="w-full sm:w-[25%] lg:w-[25%] flex flex-col items-center justify-between mb-8 sm:mb-0">
      <div className="w-full flex flex-col items-center text-center">
        <h1 className="text-lg sm:text-[18px] lg:text-[20px] text-blue-500">SIEM REAP</h1>
      ...
      <div className="w-full flex flex-col items-center text-center mt-8">
        <h1 className="text-lg sm:text-[18px] lg:text-[20px] text-blue-500">KAMPONG SPEU</h1>
        <p className="mt-2 sm:mt-4 text-base sm:text-[16px] lg:text-[20px]">
    ...
    <div className="w-full sm:w-[25%] lg:w-[25%] flex flex-col items-center justify-between mt-8 sm:mt-0">
      <div className="w-full flex flex-col items-center text-center">
        <h1 className="text-lg sm:text-[18px] lg:text-[20px] text-blue-500">PHNOM PENH</h1>
        <p className="mt-2 sm:mt-4 text-base sm:text-[16px] lg:text-[20px]">
