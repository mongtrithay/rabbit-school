...
function SupportPage() {
  return (
    <>
      <div>
        <Menu />
        <h1 className="text-[30px] sm:text-[40px] text-sky-700 font-bold text-center mt-12 sm:mt-24">
        ...
        <div className="w-[90%] sm:w-[60%] m-auto mt-10 sm:mt-14">
          <div className="flex flex-col gap-4 sm:gap-7">
            <h1 className="text-[30px] sm:text-[40px] text-sky-700 font-bold">
              DONATE RESOURCES
            </h1>
          ...
          <div className="flex flex-col sm:flex-row mt-12 sm:mt-24 gap-8">
            <div className="flex-1 flex flex-col gap-4 sm:gap-7">
              ...
              <p>
                ...
                into <br className="hidden sm:block" /> the following bank:
              </p>
              <p>
        ...
        <div className="flex flex-col sm:flex-row w-[90%] sm:w-[65%] m-auto gap-6 sm:gap-10 mt-10">
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-[18px] md:text-[25px] text-sky-700">
              <a
