      ...
      <section className="lg:mt-[50px] mt-[50px] flex  md:flex-row  flex-col-reverse">
        <div className="lg:w-[50%] lg:ml-[30px]">
          ...
          <p className="lg:ml-[60px] w-[90%] ml-[15px] mt-[10px]  text-[10px] lg:text-[20px] lg:mt-[40px]">
            ...
            School has been developing and running a vocational training program
            and job placement for several years. To support children after the
            completion of their schooling programs and to prepare them for an
            independent future, we collaborate with different companies and
          ...
          <p className="lg:ml-[60px] w-[90%] lg:text-[20px] lg:mt-[40px] ml-[15px] mt-[10px]  text-[10px]">
           <span className="font-bold"> We offer our students professional training in-house, as well as in
            partnership with specialized training organizations.</span> We have
            identified jobs in need in the region and adapted our training
            program to meet the needs of the local labor market. As people
            participating in our vocational training used to be Rabbit School
            students since early age, we have a perfect knowledge of their
            abilities and their preferences. Once their training is completed,
            they are ready to join a company for a job or an internship.
          </p>
